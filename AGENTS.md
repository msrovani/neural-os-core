...
# Current Sprint: **v1.9.99 TEST** (SESSION_275) — Mesh P2P QEMU GOAL1–3 OK (TCG): scheduler stack 8MB+guard + AgentRegistry heap-pinned; TOFU settle 130 ticks; MicroPython MVP wasmi + `mesh_g3_probe`. WHPX OVMF `#GP` / matriz cores×models abertos. Residual #513: `measure_bandwidth` / BMIDE.
