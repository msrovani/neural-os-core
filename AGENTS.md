...
# Current Sprint: **v1.9.99-s291 TEST** (Falcon3 7B alvo + AirLLM/GGUF; 1B/3B/10B por fit) — s290 PMM 64GiB. s289 ADR-0092.
...
- **Pack Falcon3 (AIOS):** primário = 7B (ou o melhor que existir). Depois, se o budget ainda couber, carrega 10B/3B/1B noutros slots. Não é “todo o FAT”; é inventário + fit.
