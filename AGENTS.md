...
# Current Sprint: **v1.9.9 TEST** (SESSION_240) — ADR-0081 Fase B gate cripto L/F (Relativizado HMAC vs Full Ed25519). Fase C ADR-0081 completa (s239). Segurança Fase A + FRAG\0 ok (s238). Mesh apps 1+2+3+4 ok (s235).
