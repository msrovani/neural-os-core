...
# Current Sprint: **v1.9.99-s290 TEST** (SESSION_290 Falcon3 3B daily / 7B FullPack ≥16GB, piso 8GB) — s289 ADR-0092 dmesg. s288 Trinity. s282 T-017 metal K23.
...
- **LLM 3B/7B full-auto (SESSION_290):** Daily=Falcon3-3B; Pro=7B só RAM≥16GB (`llm_boot_plan`). Piso produto 8GB (degradado abaixo, ainda tenta 3B). Sem teto de política. Hub FAT skip GeneratorPro fora FullPack; PIO cap=`max_resident_mb`.
