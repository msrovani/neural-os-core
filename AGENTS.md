...
# Current Sprint: **v1.9.9 TEST** (SESSION_261) — Mesh graph UI: orb → hub do grafo P2P; chat Hermes + SysInfo removidos (s261). Base mesh ADR-0081: transporte k_nano R0, ACK seletivo + backoff (s242), segurança Fase A (s238), FRAG\0/FRACK\0 (s238), apps 1-4 (s235).
