...
impl FilesystemDriver for NetFs {
    ...
    fn detect(_dev: &mut dyn crate::block_dev::BlockDevice, _lba: u64) -> Option<Self> { None }

    fn mount(&mut self, _dev: &mut dyn crate::block_dev::BlockDevice, _start_lba: u64) -> Result<FsInfo, &'static str> {
