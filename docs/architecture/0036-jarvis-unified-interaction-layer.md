...
**Pesquisa de validação:** `docs/research/jarvis-features-for-aios.md` (11 projetos, 2026-07-03). Todos os itens "O que ADOTAR" implementados: IPW, Session Compression, Skill Discovery, CapabilityContract, MCP Layer. Ver `TECNOLOGIAS.md` na raiz, seção 9, para o estado atual.
