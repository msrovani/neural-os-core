...
| `0088-aios-first-premissa-maxima.md` | Accepted | `fazendo` | **#512** #513 #534 | **PREMISSA MÁXIMA AIOS-First.** SESSION_271–272: DeviceTree H1 cedo + plano k_ai (NIC+storage+Trust+HITL recipe) antes dos drivers; SLIP degradado; Cortex sem pesos no T+0 (honesto). Residual #513: measure_bandwidth. |
...
| DeviceTree H1 + plano bind boot | **0088** + **0041** H1 | ✅ NIC (s271) + storage/Trust/HITL (s272) | SESSION_271–272 / PR #12 |
