...
| `0088-aios-first-premissa-maxima.md` | Accepted | `fazendo` | **#512** | **PREMISSA MÁXIMA AIOS-First (2026-08-07):** IA desde o boot, decisões HITL, self-* contínuo (auto-adaptar/curar/upgrade/gerar/pesquisar), nada simplesmente bypassado (todo desvio exige análise+pesquisa registrada), busca incessante dos 10% de melhoria. **PRIMEIRA a ser analisada em toda decisão**; prioriza ADR-0083 (gap camada IA) e reforça 0086 §2.7/2.8, SelfHeal, ADR-0059, ADR-0081, OptimizerAgent. |
