...
| `0105-gpu-multi-isa-kernelimage-falcon3-w2a8.md` | Accepted | `fazendo` | **#550**, #536; F4→0084 | **Canônico W2A8.** B0–B3 código ✅ (FAT/aliases, CpuOnly honesty, CPU ladder+gaps, telemetria). B1.2/B2.4/B4 = AWAITING_HW. |
