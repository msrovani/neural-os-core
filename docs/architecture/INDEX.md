...
| `0088-aios-first-premissa-maxima.md` | Accepted | `fazendo` | **#512** #513 #534 #535 | **PREMISSA MÁXIMA AIOS-First.** SESSION_271–273: DeviceTree H1 + plano k_ai (NIC+storage+Trust+HITL); Trinity único + MoE/HUD honesto; SLIP degradado; HEALTH I5 não vira LLM. Residual #513: measure_bandwidth. |
