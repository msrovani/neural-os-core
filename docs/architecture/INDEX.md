...
| `0063-tickv-noproto-ai-index-sgdb.md` | Proposed | `fazendo` | #491–#505 | **SGDB:** MVP + D-series + **Memory Quality SESSION_176** (SleepCycle ckpt, recall L4, V-flag, ART SIMD). Aceite E-series ✅; DoD 10M/100k residual. |
| `0064-rag-db-in-kernel.md` | Proposed | `fazendo` | #486–#487 | **RAG DB in-kernel:** VectorStore TF-IDF + cosine; crate `vector-db`→cortex; L1 lexical; persist via ADR-0063 TicKV `vdb/*`; F6 embeddings residual (BGE paralelo) |
