...
| `0075-emagrecer-neural-kernel.md` | Em implementação | `fazendo` | #467/#511 | **Emagrecer neural-kernel (revisão 2026-07-29):** E0 parcial (CI gate não implementado), E1a/E1c/E2/E3/E4 ✅, E1b ❌ (agents/fs/vfs não promovidos). Bin atual 20.430 LOC (−8.998 do original). ~4.943 LOC ainda recuperáveis. Alvo realista: 16.000–17.000 LOC. |
