...
| `0057-compute-dispatch-smp-gpu-npu.md` | Accepted | `completa` | #20–42, #211, #329–331, #345–346, #454–456 | **Dispatch completo:** WS-A wake multi-AP ✅ (-smp 4 APs=3); WS-B/C wired; WS-D GPU hook gated; WS-E NPU detection; WS-G decode self-test ✅. Layer S/HW residual pós-v2.0 |
...
| `0059-runtime-app-factory.md` | Accepted | `completa` | #103/#309a/#385–396/#402/#411/#8/#11/#306 + #469 | **App feita por IA:** wasmi real `add(2,3)=5` PASS; seletor A/B/C; F1-F7 majoritariamente ✅. B/C (Cranelift) gated ring+HITL |
| `0060-bitnet-cognitivo-bei.md` | Proposed | `fazendo` | #470–#478 | **BEI:** Ondas 0 (MPMC) ✅, 1 (Economia+BudgetManager) ✅, 2 (Cellular SleepCycle) ✅. A.3 Dynamic MoE (birth/merge/split) pendente — residual pre-v2. A.7 AffectVector 5D ✅ (hermes::affect). A.8 ExecutiveSupervisor 7-phase ✅ (hermes::executive) |
...
| `0064-rag-db-in-kernel.md` | Proposed | `por_fazer` | #486–#487 | **RAG DB in-kernel:** VectorStore TF-IDF **NÃO implementado** — transportado para ADR pre-v2. F6 embeddings residual |
