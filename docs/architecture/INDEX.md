...
| `0059-runtime-app-factory.md` | Accepted | `fazendo` | #103/#309a/#385–396/#402/#411/#8/#11/#306 + #469 | **App feita por IA em runtime:** **A (wasmi) ✅** (`.wasm` real PASS) + seletor A/B/C ✅ + **F7 arena W^X ✅** (nativo `mov eax,42`→42). **F6 Ring3 = BLOQUEADOR** (iretq #PF, não habilitado p/ proteger boot) → B/C nativo **gated**. Supersede ADR-0031(WASM)/0032 |
