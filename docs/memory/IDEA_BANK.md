...
| **#540** Falcon3 3B daily / 7B Pro + piso RAM 8GB / FullPack 16GB | SESSION_290 | ✅ implementado | Auto `llm_boot_plan`; sem teto de heap; bitmap 64GiB. Aceite metal pendente. |
