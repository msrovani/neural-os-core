...
| 2026-07-14 | **425** | **Hermes WASM host Caps (P3)** — Host-functions (`aios_send_tcp`, WriteRing) gated por `Cap` / CapabilityGate; negar sem Cap + log serial. Sem POSIX. | 🟡 P3 | Sprint 107 | ~150 | `capability_gate.rs` + `aios_api.rs` + ADR-0041 |
