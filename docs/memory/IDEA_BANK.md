...
| 2026-08-29 | **542** | **Mouse USB tablet QEMU não move** — `aux=0` com tablet é esperado; `MOUSE_ABS` via P24b. ✅ s382 deferred HID sandbox + DisplayAgent pós-UI. Residual EnableSlot TCG. | ✅ | - | SESSION_382 | `xhci`, InputAgent, DisplayAgent |
