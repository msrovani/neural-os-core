...
| 2026-07-14 | **435** | **N2 k-ai HW-AI / SelfHeal / HMI** — Heal/noop; HEALTH_ISSUE; inventário VID-gated (+ subclass); Trust (agent,skill). Wire crate = N2.5. | ✅ N2 CLOSED (v1.7.4; espelho até N2.5) | ADR-0042 | — | ADR-0042 + SESSION_112 |
| 2026-07-14 | **436** | **N3 cortex cérebro** — Modelo real se no FAT; MoE executa; Cap MAP_WEIGHTS; prompt→texto. **CLOSED v1.7.5:** gate `[N3-CORTEX] criteria=MET`; N3.5 crate link ⏳; soft-float fluency → Sound. | ✅ CLOSED | ADR-0042 | — | ADR-0042 |
| 2026-07-14 | **437** | **N4 hermes orquestra** — WASM SFI; skills on demand; intent e2e; cria skill/app; IPC→jarbas. **CLOSED v1.7.6:** gate `[N4-HERMES] criteria=MET`; N4.6 crate link ⏳; voz → Sound. | ✅ CLOSED | ADR-0042 | — | ADR-0042 + SESSION_114 |
| 2026-07-14 | **438** | **N5 jarbas ego/persona/+10%** — Compositor vivo; humor/UI; voz como expressão (stack pleno → Sprint Sound); só via Hermes; feedback preferências. **CLOSED v1.7.7:** gate `[N5-JARBAS] criteria=MET`; N5.7 crate link ⏳. | ✅ CLOSED | ADR-0042 + Sound (voz) | v1.7.7 | ADR-0042 + SESSION_115 |
