...
| 2026-09-21 | **#597** | **Upstream soft-float bumps** - ✅ spin 0.9→0.12 (s383). Residual: x86_64 0.15 + smoltcp 0.14 (sprint). Lazy→LazyLock deprec warnings. | 🟡 parcial | — | SESSION_383 | Cargo.toml crates |
...
| 2026-09-21 | **#599** | **wasmi 2.x no hermes** - pin **0.47.2**; bump 2.x após #597. | 🟡 | ADR-0059 | SESSION_379 | `hermes/Cargo.toml` |
