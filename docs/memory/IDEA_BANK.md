...
**Última atualização:** 2026-08-29 — SESSION_294 (#541 compositor hot path + #542 mouse tablet).
...
| **#540** Falcon3 7B alvo; 1B/3B/10B por fit + AirLLM/GGUF | SESSION_291 | ✅ | Sem SKU 8/16GB. `llm_boot_plan` + `needs_airllm_at`. |
