...
| 2026-07-14 | **435** | **N2 k-ai HW-AI / SelfHeal / HMI** — Heal de B*.LOG; HEALTH_ISSUE; inventário VID-gated; Trust (agent,skill). | ▶️ slice 1 (boot+k_ai API; falta QEMU serial + link crate) | ADR-0042 | — | ADR-0042 |
