...
| 2026-07-23 | **511** | **Emagrecer neural-kernel ADR-0075** — Cutover cirúrgico bin→crates E0–E4. Recon profundo: 29.431 LOC no bin, 12k bin_ahead (41%). Plano: promover cortex/bpe/gguf/agents/neural_fs/boot_logger → crates, depois stub. Audio deferido p/ E4 (ADR-0045). Alvo: ~11.000 LOC (redução 62%). Supersede #467. | ✅ fazendo | ADR-0075 | SESSION_215 | ADR-0075, SESSION_215, BIN_CRATE_DIFF.md |
