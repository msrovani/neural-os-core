...
| 2026-09-21 | **#599** | **wasmi 2.x no hermes** - crates.io wasmi 2.0; pin atual 0.47 no_std soft-float. Bump = sprint dedicado (API + features). | 🟡 | ADR-0059 | SESSION_377 | `hermes/Cargo.toml` |
