...
| `memory.rs` | `crates/k_nano/src/memory.rs` | 0 | 3 | 336 | `stub` | yes | already stub · already pub use |
...
| `audit.rs` | `crates/k_ai/src/audit.rs` | 0 | 2 | 281 | `stub` | yes | already stub · already pub use |
...
| `dma.rs` | `crates/k_nano/src/dma.rs` | 1 | 3 | 81 | `crate_ahead` | yes | loc 81>3 |
| `io_scheduler.rs` | `crates/k_nano/src/io_scheduler.rs` | 1 | 3 | 96 | `crate_ahead` | yes | loc 96>3 |
| `fs_driver.rs` | `crates/k_nano/src/fs_driver.rs` | 1 | 2 | 30 | `stub` | yes | already pub use |
| `storage_manager.rs` | `crates/k_nano/src/storage_manager.rs` | 1 | 3 | 42 | `crate_ahead` | yes | loc 42>3 |
...
| `cognitive.rs` | `crates/k_ai/src/cognitive.rs` | 2 | 2 | 699 | `stub` | yes | already pub use |
| `chunker.rs` | `crates/k_ai/src/chunker.rs` | 2 | 3 | 100 | `crate_ahead` | yes | loc 100>3 |
...
| `context_window.rs` | `crates/k_ai/src/context_window.rs` | 2 | 3 | 98 | `crate_ahead` | yes | loc 98>3 |
| `training_agent.rs` | `crates/k_ai/src/training_agent.rs` | 2 | 3 | 89 | `crate_ahead` | yes | loc 89>3 |
| `memory_agent.rs` | `crates/k_ai/src/memory_agent.rs` | 2 | 193 | 184 | `diverged` | NO | loc bin=193 crate=184 |
...
| `xhci.rs` | `crates/k_nano/src/xhci.rs` | 3 | 2 | 0 | `stub` | yes | already pub use |
| `usb_msc.rs` | `crates/k_nano/src/usb_msc.rs` | 3 | 233 | 225 | `diverged` | NO | loc bin=233 crate=225 |
| `virtio_net.rs` | `crates/k_nano/src/virtio_net.rs` | 3 | 466 | 439 | `bin_ahead` | NO | loc 466>439 |
| `block_dev.rs` | `crates/k_nano/src/block_dev.rs` | 3 | 43 | 74 | `crate_ahead` | yes | loc 74>43 |
| `simd.rs` | `crates/k_nano/src/simd.rs` | 3 | 2 | 82 | `stub` | yes | already pub use |
...
| `acpi.rs` | `crates/k_nano/src/acpi.rs` | 5 | 2 | 615 | `stub` | yes | RSDP unique · already pub use |
| `apic.rs` | `crates/k_nano/src/apic.rs` | 5 | 2 | 631 | `stub` | yes | LAPIC unique · already pub use |
| `smp` | `crates/k_nano/src/smp` | 5 | 659 | 1333 | `bin_ahead` | NO | dir · only_bin=['parallel_matmul.rs'] loc 659>1333 |
| `interrupts.rs` | `crates/k_nano/src/interrupts.rs` | 5 | 464 | 523 | `crate_ahead` | yes | TIMER_TICKS unique · loc 523>464 |
| `boot_logger.rs` | `crates/k_nano/src/boot_logger.rs` | 5 | 535 | 116 | `bin_ahead` | NO | promote bin · loc 535>116 |
| `global_arena.rs` | `crates/cortex/src/global_arena.rs` | 6 | 2 | 125 | `stub` | yes | pending_route · already pub use |
| `model_hub.rs` | `crates/cortex/src/model_hub.rs` | 6 | 291 | 286 | `diverged` | NO | bin truth · loc bin=291 crate=286 |
| `bpe.rs` | `crates/cortex/src/bpe.rs` | 6 | 1033 | 313 | `bin_ahead` | NO | API incompatible · loc 1033>313 |
| `cortex.rs` | `crates/cortex/src/cortex.rs` | 6 | 2524 | 2463 | `bin_ahead` | NO | boot LLM path · loc 2524>2463 |
| `agents.rs` | `crates/hermes/src/agents.rs` | 6 | 2563 | 2332 | `bin_ahead` | NO | fleet · loc 2563>2332 |
| `aios_api.rs` | `crates/hermes/src/aios_api.rs` | 6 | 92 | 77 | `diverged` | NO | loc bin=92 crate=77 |
| `micropython_wasm.rs` | `crates/hermes/src/micropython_wasm.rs` | 6 | 4 | 275 | `stub` | yes | already pub use |
| `net.rs` | `crates/k_nano/src/net.rs` | 6 | 751 | 7 | `role_diff` | NO | role_diff; keep bridge · bin=stack; k_nano=nic_globals |
