# SESSION_278 — Ring3 TCG aceite parcial (ADR-0060 §6 iretq + falta)

**Sprint:** v1.9.99 TEST  
**Data:** 2026-08-21  
**Branch:** `cursor/ring3-tcg-accept-s278`  
**Escopo:** Campanha QEMU TCG `-NoDisk` para fechar bloqueadores mensuráveis de ADR-0060 §6 (iretq CPL=3, AS sandbox, contenção de falta, boot vivo). **Não** liberar B/C / `register_native_ring`.
