//! SysInfoAgent — retry de flush do BOOT.LOG em HW real (self-heal aware).
...
//! SESSION_269: `ensure_persisted` tem circuit breaker — não spamma flush FALHOU.
...
impl Agent for SysInfoAgent {
    ...
    fn tick(&mut self, _tick: u64, _count: u64) -> AgentTickResult {
        // Self-heal path: re-probe USB-MSC + flush com backoff (SESSION_269).
        // Antes: martelava flush a cada 50 ticks → dezenas de "flush FALHOU".
