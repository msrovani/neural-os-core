...
impl MemoryAgent {
    ...
    pub fn calculate_budget(model_params: u64, total_ram_mb: u64, total_vram_mb: u64) -> MemoryBudget {
        ...
        k_ai::model_fit::set_host_memory(total_ram_mb, total_vram_mb);

        let model_mb = k_ai::model_fit::estimate_bitnet_mb(model_params) as usize;
        let heap_mb = k_ai::model_fit::estimate_heap_mb(model_params) as usize;
        let kv_mb = k_ai::model_fit::estimate_kv_mb(model_params) as usize;
        ...
        let fit = k_ai::model_fit::score_fit(
            model_mb as u64,
            kv_mb as u64,
            heap_mb as u64,
            total_ram_mb,
