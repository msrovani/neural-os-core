...
impl UvcDriverAgent {
    ...
    unsafe fn probe_camera() -> bool {
        ...
        if has_xhci {
            crate::serial_println!("[UVC] xHCI encontrado — camera USB possivel");
        ...
        crate::serial_println!("[UVC] Sem xHCI — camera indisponivel");
        false
    }
}
    ...
    fn tick(&mut self, _tick: u64, _count: u64) -> AgentTickResult {
        unsafe {
            if Self::probe_camera() {
                crate::serial_println!("[UVC] Driver camera inicializado");
