...
use jarvis::audio::settings::AUDIO_VOLUME;
use jarvis::audio::voice::AUDIO_RING;
...
impl AudioMixerAgent {
    pub fn new() -> Self {
        AudioMixerAgent {
            tts_receiver: k_nano::EVENT_BUS.subscribe(jarvis::audio::TOPIC_AUDIO_OUT),
            out_ring: &AUDIO_RING,
        }
    }
}
...
impl Agent for AudioMixerAgent {
    ...
    fn tick(&mut self, _tick: u64, _count: u64) -> AgentTickResult {
        ...
        if n > 0 {
            jarvis::audio::hda::write_hda_playback(&hda_buf[..n]);
        }
