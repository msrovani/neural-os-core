...
| 2.10c | **K-IA DMA pin + Cortex mmap (P5)** | 🔄 Cap PIN/MAP_DMA + MAP_WEIGHTS; frames pinados + AS; mmap pesos eager (simulado). VirtIO/GGUF TODO. ADR-0041 P5. | Cap + DMA pin + mmap | MIT | `k_ia_dma.rs`, `cortex_mmap.rs` | 🔄 PoC |
