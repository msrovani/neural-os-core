...
Este documento guia a configuração completa do ambiente de desenvolvimento do **AIOS K³CHJ (neural-os-core)** — um sistema operacional bare-metal em Rust (`no_std`, `no_main`) com 41 agentes nativos, IA nativa, GPU compute, e auto-recuperação.
